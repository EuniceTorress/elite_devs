...
.sidebar-link li .fa-building {
    background-color: rgba(65,1,4,0.1);
    color: #410104;
}

.sidebar-link li .fa-clipboard {
...
.sidebar-link:hover li .i{
    background-color: rgba(0,0,0,0.1);
    color: black;
}

.sidebar-link li .dropdown-icon {
    right: 5px;
    position: absolute;
    padding: 10px;
    font-size: 10px;
...
<nav id="sidebar">
    ...
    <a href="user-homepage.php?type=dashboard" type="button" class="sidebar-link <?= $type == 'dashboard' ? 'active' : '' ?>"><li><i class="fas fa-tachometer-alt i"></i> Dashboard</li></a>
    <a href="user-homepage.php?type=stocks" type="button" class="sidebar-link <?= $type == 'stocks' ? 'active' : '' ?>"><li><i class="fas fa-boxes i"></i> Stocks</li></a>
    ...
    <a id="pb" href="#posDD" data-toggle="collapse" type="button" class="sidebar-link <?= strpos($type, 'sales') !== false ? 'active' : '' ?>"><li><i class="fas fa-cash-register i"></i> Sales<span id="posDDB" class="fas fa-chevron-down dropdown-icon"></span></li></a>
    ...
    <a href="user-homepage.php?type=logs" type="button" class="sidebar-link <?= $type == 'logs' ? 'active' : '' ?>"><li><i class="fas fa-clipboard i"></i> Logs</li></a>
    </ul>
</nav>
